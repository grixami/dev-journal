                            ...
                            <div className="flex items-center justify-center mt-4">
                                <div className="w-full">
                                    <div className="flex flex-col items-center justify-center w-full">
                                        ...
                                        <input type="text" id="posttitle" name="title" maxLength={50} defaultValue={postTitle} className="border-2 w-[80%] rounded-3xl px-4 py-2 border-white focus:border-[#5a9ef9] focus:outline-none mt-2"
