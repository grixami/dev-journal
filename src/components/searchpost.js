    ...
    return(
        <div>
            <a href={`/post/${post.id}/view`}>
                <div className="flex border-2 border-white rounded-xl px-5 py-5 my-5 transform transition-transform duration-500 ease-in-out hover:translate-x-[7.5%] hover:bg-[#35383d]">
